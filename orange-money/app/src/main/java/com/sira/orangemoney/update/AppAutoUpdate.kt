...
class AppAutoUpdate(private val context: Context) {
    ...
    fun check(): UpdateInfo? {
        ...
        val conn = (URL("https://sira-manager-admin.vercel.app/api/updates/latest?app=orange&version=$version").openConnection() as HttpURLConnection)
        return try {
    ...
    fun downloadAndInstall(info: UpdateInfo): Result<Unit> = runCatching {
        ...
        val apk = File(dir, "sira-orange-money-${info.latestVersion}.apk")
